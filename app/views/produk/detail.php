        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <button class="w-full bg-[#A67C52] text-white font-bold py-3 px-6 rounded-lg hover:bg-[#8C6847] transition duration-300">Sewa Sekarang</button>
                </div>
            </div>
                ...
                <div id="content-reviews" class="tab-content py-6 hidden">
                    <div class="mb-8">
                        ...
                        <form action="<?= BASEURL; ?>/produk/ulasan" method="post">
                            ...
                            <div class="mb-4">
                                <label for="comment" class="block mb-2 text-sm font-medium text-gray-900">Ulasan Anda</textarea>

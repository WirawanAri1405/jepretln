                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="answer" name="answer" rows="4"
                            ...
                            placeholder="Tulis jawaban disini" required></textarea>
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="sort_order"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Urutan Tampil</label>
                        <input type="number" name="sort_order" id="sort_order"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5"
                            placeholder="Contoh: 1" value="0" required>
                    </div>
                </div>
                <button type="submit"

                 ...
                 <div class="overflow-x-auto ">
                     <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                         <thead
                             ...
                             <tr>
                                 <th scope="col" class="px-4 py-3">ID FAQ</th>
                         ...
                         <tbody>
                             <tr class="border-b dark:border-gray-700 ">
                                 <th scope="row"
                                     ...
                                     5595</th>
                                 <td class="px-4 py-3">cara menyewa kamera?</td>
                                 <td class="px-4 py-3">sialahkan berkunjung ke jepretln</td>
                                 <td class="px-4 py-3">draft</td>

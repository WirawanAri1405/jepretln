                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        ...
                        <?php for ($i = 1; $i <= $data['total_pages']; $i++) : ?>
                            <li>
                                ...
                                $pageHref = BASEURL . '/Admin/ManajemenProduk?' . http_build_query($pageParams);
                                ?>
                                <a href="<?= $pageHref ?>"
                        ...
                        <li>
                            ...
                            $nextHref = ($data['current_page'] < $data['total_pages']) ? BASEURL . '/Admin/ManajemenProduk?' . http_build_query($nextPageParams) : '#';
                            ?>
                            <a href="<?= $nextHref ?>"

            ...
            <?php if ($data['product']) : ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <a href="<?= BASEURL; ?>/Admin/ManajemenProduk" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kembali</a>
                    </div>
                </div>

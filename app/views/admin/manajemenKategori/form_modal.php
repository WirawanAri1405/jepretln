    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form class="p-4 md:p-5" action="<?= BASEURL; ?>/Admin/ManajemenKategori/tambah" method="post" enctype="multipart/form-data">
                <div class="grid gap-6 mb-4 grid-cols-1">
                    <div>
                        <label for="name"
                    ...
                    <div>
                        <label for="image-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar Kategori</label>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">PNG, JPG, atau JPEG (MAX. 10MB).</p>

                        <img id="image-preview" class="hidden mt-4 w-32 h-32 object-cover rounded-lg border border-gray-200 dark:border-gray-600" src="#" alt="Pratinjau Gambar" />
                    </div>
                    <div>
                        <h3 class="text-md font-semibold text-gray-900 dark:text-white mb-2 border-t border-gray-200 dark:border-gray-700 pt-4">Template Spesifikasi</h3>

                        <div id="spec-fields-container-modal" class="space-y-3">
                        </div>

                        <button type="button" id="add-spec-field-modal" class=" mt-4 text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400">
